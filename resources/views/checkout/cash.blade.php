	...
	<div class="content-wrap">
		<div class="container clearfix">
			<div class="alert alert-info mb-5">
				<div class="text-center font-weight-bold" style="font-size:20px;">Confirmation Order</div>
			</div>
			<form action="{{ url('checkout/cash') }}" method="POST">
				@csrf
				<div class="row col-mb-50 gutter-50 justify-content-end">
					...
					<div class="col-lg-6">
						...
						<button type="submit" class="button button-3d float-right">Submit Order</button>
					</div>
				</div>
			</form>
		</div>
