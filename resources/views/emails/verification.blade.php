                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="{{ $link }}" target="_blank">Verification Now</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Surabaya, Baliwerti 119-121 Kav. 10, Jawa Timur</span>
                    <br>(+62) 811332642.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Copyright &copy; smartmarbleandbath.com.
                  </td>
                </tr>
              </table>
            </div>
