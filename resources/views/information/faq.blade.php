               ...
               <div id="faqs" class="faqs">
                  ...
                  <ul class="iconlist faqlist">
                     <li>
                        ...
                        <a href="#" data-scrollto="#faq-1">What's the difference between "add to chart" and "add to wishlist"</a>
                     </li>
                     <li>
                        <i class="icon-caret-right"></i>
                        <a href="#" data-scrollto="#faq-2">What's the difference between "Pay on Cashier" and "Pay Online"?</a>
                     </li>
                     <li>
                        <i class="icon-caret-right"></i>
                        <a href="#" data-scrollto="#faq-4">How to check the availability of product?</a>
                     </li>
                     <li>
                        <i class="icon-caret-right"></i>
                        <a href="#" data-scrollto="#faq-4">How if we want to buy in large quantities through website?</a>
                     </li>
                  </ul>
                  <div class="divider"><i class="icon-circle"></i></div>
                  <h3 id="faq-1"><strong>Q.</strong> What's the difference between "add to chart" and "add to wishlist"</h3>
                  <p>A wishlist is a list of preferred products that customer can save or transfer to the cart later. Add to chart is a shopping cart to buy your product and proceed into payment section.</p>
