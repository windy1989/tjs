				...
				<div class="row justify-content-between align-items-center">
					<div class="col-12 col-md-auto">
						<p class="mb-0 py-2 text-center text-md-left">
							<strong>Call:</strong> (+62) 811332642 | <strong>Email:</strong> info@smartmarbleandbath.com
						</p>
					</div>
					<div class="col-12 col-md-auto">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						<div id="logo">
							<a href="{{ url('/') }}" class="standard-logo" data-dark-logo="{{ asset('website/logo-black.png') }}">
								<img src="{{ asset('website/logo-black.png') }}" alt="Logo">
							</a>
							<a href="{{ url('/') }}" class="retina-logo" data-dark-logo="{{ asset('website/logo-black.png') }}">
								<img src="{{ asset('website/logo-black.png') }}" alt="Logo">
							</a>
						</div>
