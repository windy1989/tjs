				...
				<div class="card-body">
					...
					<div class="table-responsive mt-4">
						<table class="table table-bordered table-sm table-striped">
							...
							<tfoot>
								<tr>
									<td colspan="3" rowspan="5" class="align-middle">
										<div class="font-weight-semibold">Comments or Special Instructions :</div><br>
										<div>1. Down Payment is 50% from the total</div>
										<div>2. The goods must be shipped to Jakarta before May 19th, 2021. If the goods are not in stock, please send the Concealed Body Art. HT5716ZZ11 first.</div>
										</ol>
									</td>
								</tr>
								<tr>
					...
					<div class="mt-3 text-center font-italic font-weight-normal">If you have any questions about this invoice, please email: <a href="mailto:smartmarbleandbath@gmail.com">smartmarbleandbath@gmail.com</a> or phone : <a href="tel:0315477501">031-5477501</a></div>
