   <div class="container-fluid">
      <h1 class="h3 mb-4 text-gray-800">Master Company</h1>
      <div class="card shadow">
         <div class="card-header">
            <div class="row">
               <div class="col-md-6">
                  <h6 class="m-0 font-weight-bold mt-2">List Master Company</h6>
               </div>
...
<div class="modal fade" id="modal_form" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  function success() {
   ...
   function loadDataTable() {
      $('#datatable_serverside').DataTable({
         ...
         scrollX: true,
         ajax: {
            url: '{{ url("admin/master_data/company/datatable") }}',
            type: 'POST',
            headers: {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/master_data/company/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/company/show") }}',
         type: 'POST',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/company/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
   ...
   function destroy(id) {
      Swal.fire({
         ...
         if(result.value) {
            $.ajax({
               url: '{{ url("admin/master_data/company/destroy") }}',
               type: 'POST',
               dataType: 'JSON',
               data: {
                  id: id
