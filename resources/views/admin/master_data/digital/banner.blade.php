		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Banner</span>
				</h4>
			</div>
               ...
               <div class="form-group">
                  ...
                  <center class="mt-3">
                     <a href="{{ asset("website/empty.jpg") }}" id="preview_image" data-lightbox="Banner" data-title="Preview Image">
                        <img src="{{ asset("website/empty.jpg") }}" class="img-fluid img-thumbnail w-100" style="max-width:250px;">
                     </a>
                  </center>
               </div>
  ...
  function success() {
   ...
   function loadDataTable() {
      $('#datatable_serverside').DataTable({
         ...
         order: [[0, 'asc']],
         ajax: {
            url: '{{ url("admin/master_data/digital/banner/datatable") }}',
            type: 'GET',
            data: {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/master_data/digital/banner/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/digital/banner/show") }}',
         type: 'GET',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/digital/banner/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: new FormData($('#form_data')[0]),
         contentType: false,
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/master_data/digital/banner/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
