		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Career</span>
				</h4>
			</div>
			<div class="header-elements">
				<div class="d-flex justify-content-center">
					...
					<a href="{{ url('admin/master_data/digital/career/create') }}" class="btn bg-primary btn-labeled btn-labeled-left">
...
<script>
   ...
   function loadDataTable() {
      $('#datatable_serverside').DataTable({
         ...
         order: [[0, 'asc']],
         ajax: {
            url: '{{ url("admin/master_data/digital/career/datatable") }}',
            type: 'GET',
            data: {
         ...
         columns: [
            ...
            { name: 'deadline', className: 'text-center align-middle' },
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/master_data/digital/career/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
