		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Update Career</span>
				</h4>
			</div>
			<div class="header-elements">
				<div class="d-flex justify-content-center">
					<a href="{{ url('admin/master_data/digital/career') }}" class="btn bg-secondary btn-labeled btn-labeled-left">
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<a href="{{ url('admin/master_data/digital/career') }}" class="breadcrumb-item">Career</a>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control" placeholder="Enter title" value="{{ old('title', $career->title) }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label>Deadline :<span class="text-danger">*</span></label>
                        <input type="date" name="deadline" id="deadline" class="form-control" value="{{ old('deadline', $career->deadline) }}">
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  <label>Description :<span class="text-danger">*</span></label>
                  <textarea name="description" id="description" class="description">{!! old('description', $career->description) !!}</textarea>
               </div>
               <div class="form-group">
                  <label>Requirements :<span class="text-danger">*</span></label>
                  <textarea name="requirements" id="requirements" class="requirements">{!! old('requirements', $career->requirements) !!}</textarea>
               </div>
