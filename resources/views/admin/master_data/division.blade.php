   <div class="container-fluid">
      <h1 class="h3 mb-4 text-gray-800">Master Division</h1>
      <div class="card shadow">
         <div class="card-header">
            <div class="row">
               <div class="col-md-6">
                  <h6 class="m-0 font-weight-bold mt-2">List Master Division</h6>
               </div>
...
<script>
  ...
  function success() {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/master_data/division/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/division/show") }}',
         type: 'POST',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/division/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
   ...
   function destroy(id) {
      Swal.fire({
         ...
         if(result.value) {
            $.ajax({
               url: '{{ url("admin/master_data/division/destroy") }}',
               type: 'POST',
               dataType: 'JSON',
               data: {
                  id: id
