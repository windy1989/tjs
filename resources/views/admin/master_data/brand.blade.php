	...
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline mb-3">
				<h5 class="card-title">List Data Brand</h5>
				<div class="header-elements">
               ...
               <div class="form-group">
                  ...
                  <center class="mt-3">
                     <a href="{{ asset("website/empty.jpg") }}" id="preview_image" data-lightbox="Brand" data-title="Preview Image">
                        <img src="{{ asset("website/empty.jpg") }}" class="img-fluid img-thumbnail w-100" style="max-width:200px;" alt="Brand Image">
                     </a>
                  </center>
               </div>
...
<script>
  ...
  function success() {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/master_data/brand/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/brand/show") }}',
         type: 'POST',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/brand/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: new FormData($('#form_data')[0]),
         contentType: false,
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/master_data/brand/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
