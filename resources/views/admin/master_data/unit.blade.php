		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Master Unit</span>
				</h4>
			</div>
	...
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline mb-3">
				<h5 class="card-title">List Data Unit</h5>
				<div class="header-elements">
   ...
   <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
         <div class="modal-header bg-light">
            <h5 class="modal-title" id="exampleModalLabel">Form Unit</h5>
  ...
  function success() {
   ...
   function loadDataTable() {
      $('#datatable_serverside').DataTable({
         ...
         order: [[0, 'asc']],
         ajax: {
            url: '{{ url("admin/master_data/unit/datatable") }}',
            type: 'POST',
            headers: {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/master_data/unit/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/unit/show") }}',
         type: 'POST',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/unit/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/master_data/unit/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
