		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Freight</span>
				</h4>
			</div>
...
<script>
  ...
  function success() {
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/cogs_master/freight/show") }}',
         type: 'GET',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/cogs_master/freight/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/master_data/cogs_master/freight/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
