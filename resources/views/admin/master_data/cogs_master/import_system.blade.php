		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Import System</span>
				</h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Import System</span>
				</div>
			</div>
		</div>
	</div>
...
<script>
  ...
  function success() {
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/cogs_master/import_system/show") }}',
         type: 'GET',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/cogs_master/import_system/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/master_data/cogs_master/import_system/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
