   <div class="container-fluid">
      <h1 class="h3 mb-4 text-gray-800">Master Country</h1>
      <div class="card shadow">
         <div class="card-header">
            <div class="row">
               <div class="col-md-6">
                  <h6 class="m-0 font-weight-bold mt-2">List Master Country</h6>
               </div>
   ...
   <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Form Country</h5>
  ...
  function success() {
   ...
   function loadDataTable() {
      $('#datatable_serverside').DataTable({
         ...
         scrollX: true,
         ajax: {
            url: '{{ url("admin/master_data/country/datatable") }}',
            type: 'POST',
            headers: {
         ...
         columns: [
            ...
            { name: 'phone_code', className: 'text-center align-middle' },
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/master_data/country/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/master_data/country/show") }}',
         type: 'POST',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/master_data/country/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
   ...
   function destroy(id) {
      Swal.fire({
         ...
         if(result.value) {
            $.ajax({
               url: '{{ url("admin/master_data/country/destroy") }}',
               type: 'POST',
               dataType: 'JSON',
               data: {
                  id: id
