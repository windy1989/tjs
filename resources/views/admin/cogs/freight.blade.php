		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Cogs Freight</span>
				</h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Freight</span>
				</div>
			</div>
		</div>
	</div>
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline mb-3">
				<h5 class="card-title">List Data Freight</h5>
			</div>
			<div class="card-body">
         ...
         <div class="modal-body">
            <form id="form_data">
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="cost" id="cost" class="form-control number" placeholder="Enter cost">
               </div>
            </form>
         </div>
  ...
  function success() {
   ...
   function loadDataTable() {
      $('#datatable_serverside').DataTable({
         ...
         order: [[0, 'asc']],
         ajax: {
            url: '{{ url("admin/cogs/freight/datatable") }}',
            type: 'POST',
            headers: {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/cogs/freight/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/cogs/freight/show") }}',
         type: 'POST',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/cogs/freight/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/cogs/freight/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
