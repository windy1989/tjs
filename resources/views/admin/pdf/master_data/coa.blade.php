			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				<thead>
					<tr style="background:#b51405;text-align:center;">
						...
						<th style="color:white;"><center>PARENT</center></th>
						<th style="color:white;"><center>STATUS</center></th>
						<th style="color:white;"><center>CREATED</center></th>
						<th style="color:white;"><center>UPDATED</center></th>
					</tr>
				</thead>
				<tbody>
					@foreach($coa as $key => $r )
						<tr>
