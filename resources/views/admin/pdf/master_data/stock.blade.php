		...
		<div class="invoice-box">
			...
			<table cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2">
						<center>
							Page {{ Request::get('page').' / '.$result->total_page.' Pages' }}
						</center>
					</td>
				</tr>
			</table><br>
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				<thead>
					<tr style="background:#b51405;text-align:center;">
						...
						<th style="color:white;"><center>WAREHOUSE</center></th>
						<th style="color:white;"><center>WAREHOUSE NAME</center></th>
						...
						<th style="color:white;"><center>GROUP</center></th>
					</tr>
				</thead>
				<tbody>
