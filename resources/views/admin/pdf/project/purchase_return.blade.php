...
<html lang="en">
	<head>
		...
		<title>Purchase Return {{ $project->code }}</title>
		<style>
			.invoice-box {
				font-size: 16px;
	...
	<body>
		<div class="invoice-box">
					...
					<td colspan="2">
						<table width="100%">
							<tr style="line-height:0 !important;">
								<td width="20%" style="font-size:10px;">Purchase No.</td>
								<td style="text-align:left; font-size:10px;">: {{ $project->projectPurchase->code }}</td>
								<td></td>
								<td></td>
							...
							<tr style="line-height:0 !important;">
								<td width="20%" style="font-size:10px;">Purchase Return</td>
							...
							<tr style="line-height:0 !important;">
								...
								<td style="text-align:left; font-size:10px;">: {{ $project->projectPurchase->projectSale->code }}</td>
								<td></td>
								<td></td>
								<td width="20%" style="font-size:10px;"></td>
								<td style="text-align:left; font-size:10px;"></td>
							...
							<tr style="line-height:0 !important;">
								<td width="20%" style="font-size:10px;">Supplier</td>
								<td style="text-align:left; font-size:10px;">: {{ $project->projectPurchase->supplier->name }}</td>
								<td></td>
								<td></td>
								<td width="20%" style="font-size:10px;"></td>
								<td style="text-align:left; font-size:10px;"></td>
							...
							<tr style="line-height:0 !important;">
								...
								<td style="text-align:left; font-size:10px;">: {{ $project->created_at }}</td>
								<td></td>
								<td></td>
								<td width="20%" style="font-size:10px;"></td>
								<td style="text-align:left; font-size:10px;"></td>
							...
							<tr style="line-height:0 !important;">
								<td width="20%" style="font-size:10px;">From Warehouse</td>
								<td style="text-align:left; font-size:10px;">: {{ $project->warehouse->name }}</td>
								<td></td>
								<td></td>
								<td></td>
								<td></td>
			...
			@php
				...
				$totaltile = 0;
				$totallain = 0;
				foreach($project->projectPurchaseReturnProduct as $key => $pp){
