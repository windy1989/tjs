		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Detail Voucher</span>
				</h4>
			</div>
            ...
            <table cellpadding="10" cellspacing="0" width="100%">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="align-middle">: {{ number_format($voucher->minimum) }}</td>
                  </tr>
                  <tr>
                     <th width="20%" class="align-middle">Maximum Discount / Point</th>
                     <td class="align-middle">: {{ number_format($voucher->maximum) }}</td>
                  </tr>
                  <tr>
