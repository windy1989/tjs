		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Delivery Vendor</span>
				</h4>
			</div>
	...
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline mb-3">
				<h5 class="card-title">List Data Vendor</h5>
				<div class="header-elements">
...
<script>
  ...
  function success() {
   ...
   function create() {
      $.ajax({
         url: '{{ url("admin/delivery/vendor/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/delivery/vendor/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/delivery/vendor/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
