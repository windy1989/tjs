...
<div id="side-panel" class="dark side-panel-filter">
      ...
      <div class="widget clearfix">
         ...
         <div class="sidebar">
            <div class="sidebar-widgets-wrap">
               ...
               <div class="mb-5 clearfix" data-readmore="true" data-readmore-maskcolor="rgba(0, 0, 0, .1)" data-readmore-masksize="0%" data-readmore-trigger-open="<div style='font-size:14px !important;' class='text-white'>Read More <i class='icon-angle-down'></i></div>" data-readmore-trigger-close="<div style='font-size:14px !important;' class='text-white'>Hide <i class='icon-angle-up'></i></div>">
                  ...
                  <ul>
                     @foreach($brand as $b)
                        <li>
                           <div class="form-check">
                              <input type="checkbox" class="form-check-input" name="brand[]" id="{{ $b->code }}" value="{{ $b->code }}" {{ in_array($b->code, $filter['brand']) ? 'checked' : '' }}>
                              <label class="form-check-label font-weight-normal" style="font-size:10px !important;" for="{{ $b->code }}">{{ $b->name }}</label>
                           </div>
                        </li>
                     @endforeach
                     <li>
               ...
               <div class="mb-5 clearfix" data-readmore="true" data-readmore-maskcolor="rgba(0, 0, 0, .1)" data-readmore-masksize="0%" data-readmore-trigger-open="<div style='font-size:14px !important;' class='text-white'>Read More <i class='icon-angle-down'></i></div>" data-readmore-trigger-close="<div style='font-size:14px !important;' class='text-white'>Hide <i class='icon-angle-up'></i></div>">
                  ...
                  <ul>
                     @foreach($size as $s)
                        <li>
                           <div class="form-check">
                              <input type="checkbox" class="form-check-input" name="size[]" id="{{ $s->length }}x{{ $s->width }}" value="{{ $s->length }}x{{ $s->width }}" {{ in_array($s->length . 'x' . $s->width, $filter['size']) ? 'checked' : '' }}>
                              <label class="form-check-label font-weight-normal" style="font-size:10px !important;" for="{{ $s->length }}x{{ $s->width }}">{{ $s->length }}x{{ $s->width }}</label>
                           </div>
                        </li>
                     @endforeach
                     <li>
               ...
               <div class="mb-5 clearfix" data-readmore="true" data-readmore-maskcolor="rgba(0, 0, 0, .1)" data-readmore-masksize="0%" data-readmore-trigger-open="<div style='font-size:14px !important;' class='text-white'>Read More <i class='icon-angle-down'></i></div>" data-readmore-trigger-close="<div style='font-size:14px !important;' class='text-white'>Hide <i class='icon-angle-up'></i></div>">
                  ...
                  <ul>
                     @foreach($color as $c)
                        <li>
                           <div class="form-check">
                              <input type="checkbox" class="form-check-input" name="color[]" id="{{ $c->code }}" value="{{ $c->code }}" {{ in_array($c->code, $filter['color']) ? 'checked' : '' }}>
                              <label class="form-check-label font-weight-normal" style="font-size:10px !important;" for="{{ $c->code }}">{{ $c->name }}</label>
                           </div>
                        </li>
                     @endforeach
                     <li>
               ...
               <div class="clearfix" data-readmore="true" data-readmore-maskcolor="rgba(0, 0, 0, .1)" data-readmore-masksize="0%" data-readmore-trigger-open="<div style='font-size:14px !important;' class='text-white'>Read More <i class='icon-angle-down'></i></div>" data-readmore-trigger-close="<div style='font-size:14px !important;' class='text-white'>Hide <i class='icon-angle-up'></i></div>">
                  <h4 class="mb-3 text-uppercase" style="font-size:15px;">Pattern</h4>
                  <ul>
                     @foreach($pattern as $p)
                        <li>
                           <div class="form-check">
                              <input type="checkbox" class="form-check-input" name="pattern[]" id="{{ $p->code }}" value="{{ $p->code }}" {{ in_array($p->code, $filter['pattern']) ? 'checked' : '' }}>
                              <label class="form-check-label font-weight-normal" style="font-size:10px !important;" for="{{ $p->code }}">{{ $p->name }}</label>
                           </div>
                        </li>
                     @endforeach
                     <li>
...
<button id="side-panel-filter-trigger">Trigger</button>
