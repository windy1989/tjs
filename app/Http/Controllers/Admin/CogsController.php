...
class CogsController extends Controller {
    ...
    public function getCompleteData(Request $request)
    {
        ...
        return response()->json([
            ...
            'rate_of_usd'            => '$' . (!is_nan($ru) && !is_infinite($ru) ? number_format($ru, 0, ',', '.') : 0),
    ...
    public function show(Request $request)
    {
        ...
        return response()->json([
            ...
            'agent_fee_usd'          => '$' . number_format($data->agent_fee_usd, 0, ',', '.'),
            ...
            'rate_of_usd'            => '$' . number_format($formula->rate_of_usd, 0, ',', '.'),
